...
namespace idmef
{
	public class Inode
	{
		...
		public Inode(DateTime? changeTime, Int64? number, Int16? majorDevice, Int16? minorDevice,
					 Int16? cMajorDevice, Int16? cMinorDevice)
		{
			...
			if ((number != null) && (majorDevice != null) && (minorDevice != null))
			{
				...
				throw new ArgumentException(
					"Inode class must have either number, major-device and minor-device nodes together or neither of them at all.");
			if ((cMajorDevice != null) && (cMinorDevice != null))
			{
				...
				throw new ArgumentException(
					"Inode class must have either c-major-device and c-minor-device nodes together or neither of them at all.");
		}
		...
		public XmlElement ToXml(XmlDocument document)
		{
			...
			if (changeTime != null)
			{
				...
				XmlNode subNode =
					document.CreateNode(XmlNodeType.Text, "idmef", "change-time", "http://iana.org/idmef");
			...
			if (majorDevice != null)
			{
				...
				XmlNode subNode =
					document.CreateNode(XmlNodeType.Text, "idmef", "major-device", "http://iana.org/idmef");
			...
			if (minorDevice != null)
			{
				...
				XmlNode subNode =
					document.CreateNode(XmlNodeType.Text, "idmef", "minor-device", "http://iana.org/idmef");
			...
			if (cMajorDevice != null)
			{
				...
				XmlNode subNode =
					document.CreateNode(XmlNodeType.Text, "idmef", "c-major-device", "http://iana.org/idmef");
			...
			if (cMinorDevice != null)
			{
				...
				XmlNode subNode =
					document.CreateNode(XmlNodeType.Text, "idmef", "c-minor-device", "http://iana.org/idmef");
